...
FlagUmStandardFattura: number;
/** Reflected: __Dati_Numero061*/ 
FlagUmAltFattura: number;
/** Reflected: __Dati_Testo068*/ 
UmItemAlternativa: string;
...
QuantitaDefinitivoItemUmAlt: number;
/** Reflected: __Dati_Numero066*/ 
QuantitaVariazioneItemUmAlt: number;
/** Reflected: __Dati_Numero067*/ 
FlagEscludiDichiarazioneIntento: number;
