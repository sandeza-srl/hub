export interface IInventariItemsVoci {
  _id: string;
  /** Reflected: __Dati_Testo001*/ 
  IdInventarioItemVoce: string;
  ...
  QtGiacenza_DOp02: number;
  /** Reflected: __Dati_Numero005*/ 
  QtIngresso_DOp01: number;
  /** Reflected: __Dati_Numero006*/ 
  QtUscita_DOp01: number;
  ...
  DataOraRettifica: Date;
  /** Reflected: __Dati_Numero007*/ 
  FlagAggiornaQta01: number;
  /** Reflected: __Dati_Numero008*/ 
  FlagRettificaCreata: number;
  /** Reflected: __Dati_Numero009*/ 
  QtRettificaDaEffettuare03: number;
  /** Reflected: __Dati_Numero010*/ 
  FlagAggiornaQta02: number;
  /** Reflected: __Dati_Numero011*/ 
  FlagAggiornaQta03: number;
  ...
  IdInventarioItem: string;
  /** Reflected: __Dati_Numero012*/ 
  QtRettificaEffettuata03: number;
