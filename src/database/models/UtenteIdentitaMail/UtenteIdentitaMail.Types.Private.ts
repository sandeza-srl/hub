export interface IUtenteIdentitaMailPrivate {
  _id: string;
  /** Reflected: IdUtente*/ 
  ...
  /** Reflected: NomeAccountMail*/ 
  __Dati_Testo004: string;
  /** Reflected: PasswordAccountMail*/ 
  __Dati_Testo005: string;
  /** Reflected: PasswordAccountMailVisualizza*/ 
  ...
  /** Reflected: TxtIdentita*/ 
  __Dati_Testo009: string;
  /** Reflected: IdIdentita*/ 
