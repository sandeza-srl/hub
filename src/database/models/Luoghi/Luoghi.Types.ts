...
FlagMinOperatori: number;
/** Reflected: __Dati_Testo004*/ 
FlagMinOperatoriVedi: string;
/** Reflected: __Dati_Numero005*/ 
FlagMaxOperatori: number;
/** Reflected: __Dati_Testo005*/ 
FlagMaxOperatoriVedi: string;
