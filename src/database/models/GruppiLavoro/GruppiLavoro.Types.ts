export interface IGruppiLavoro {
_id: string;
/** Reflected: __Dati_Testo001*/ 
IdGruppoLavoro: string;
...
CodiceGruppoLavoro: string;
/** Reflected: __Dati_Numero003*/ 
FlagAggiorna_DaOperatoriGruppiLavoro: number;
/** Reflected: __Dati_Testo011*/ 
IdReferenteTipiRuoliTipiGruppoLavoro: string;
/** Reflected: __Dati_Testo012*/ 
IdOperatoriGruppoLavoro_Tutti: string;
/** Reflected: __Dati_Testo013*/ 
IdTipoGruppoLavoro: string;
/** Reflected: __Dati_Testo014*/ 
TxtTipoGruppoLavoro: string;
/** Reflected: __Dati_Testo015*/ 
TxtOperatoreResponsabileGruppoLavoro: string;
/** Reflected: __Dati_Testo016*/ 
TxtOperatoriGruppoLavoro_Tutti: string;
/** Reflected: __Dati_Testo017*/ 
IdReferenteGruppoLavoro: string;
