export interface ITipiDocContabili {
_id: string;
...
GeneraCodice_FlagTxtPeriodoContabileVisibileVedi: string;
...
GeneraCodice_FlagUsaCodiceAltroVedi: string;
/** Reflected: __Dati_Testo012*/ 
GeneraCodice_IdTipoDocContabilePerCodice: string;
...
CodiceCausaleContabile: string;
/** Reflected: __Dati_Numero025*/ 
FlagDataContabileRegistrazione: number;
/** Reflected: __Dati_Testo019*/ 
IdCodificaTipoDocContabili: string;
...
IdTipoDocumentoXML: string;
/** Reflected: __Dati_Testo024*/ 
IdSottoTipoDocumentoXML: string;
