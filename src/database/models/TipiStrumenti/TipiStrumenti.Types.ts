export interface ITipiStrumenti {
  _id: string;
  ...
  NumeroStrumentiRottamati: number;
  /** Reflected: __Dati_Numero008*/ 
  NumeroStrumentiTotali: number;
  ...
  NumeroStrumentiDisponibili: number;
  /** Reflected: __Dati_Numero010*/ 
  NumeroStrumentiInVerifica: number;
