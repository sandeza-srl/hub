export interface IInfoAggiuntiveDistintaImpianto {
  _id: string;
  ...
  TestoInformazioneAutomatico: string;
  ...
  IdInfoAggiuntiveDistintaImpianto: string;
  ...
  IdRigaDistintaImpiantoAttiva: string;
