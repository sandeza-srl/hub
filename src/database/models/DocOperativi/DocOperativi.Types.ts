...
FlagCondizioni_CompetenzeRichieste: number;
/** Reflected: __Dati_Numero191*/ 
FlagPerStati_CompetenzeDaInserire: number;
...
LimitazioniScheda_AccessoScheda_FlagLimitato: number;
/** Reflected: __Dati_Numero194*/ 
LimitazioniScheda_Creazione_FlagLimitato: number;
/** Reflected: __Dati_Numero195*/ 
LimitazioniScheda_Eliminazione_FlagLimitato: number;
/** Reflected: __Dati_Numero196*/ 
LimitazioniScheda_VisibilitaValoriEconomici_FlagLimitato: number;
/** Reflected: __Dati_Testo158*/ 
Log_Creazione: string;
/** Reflected: __Dati_Testo159*/ 
Log_Modifica: string;
/** Reflected: __Dati_Testo160*/ 
Log_ScriptEseguiti: string;
/** Reflected: __Dati_Testo161*/ 
Log_ModificaFlagStatiSequenzaTxt: string;
/** Reflected: __Dati_Testo162*/ 
Log_ModificaDataDocOperativo: string;
/** Reflected: __Dati_Testo163*/ 
Log_Progressivo: string;
/** Reflected: __Dati_Numero197*/ 
Multimagazzino_Svincola: number;
/** Reflected: __Dati_Testo164*/ 
IdMagazziniGestitiOriginePossibili_Svincolati: string;
/** Reflected: __Dati_Testo165*/ 
IdMagazziniGestitiDestinazionePossibili_Svincolati: string;
/** Reflected: __Dati_Testo166*/ 
IdMagazzinoGestitoDestinazione_Svincolato: string;
/** Reflected: __Dati_Testo167*/ 
IdMagazzinoGestitoOrigine_Svincolato: string;
/** Reflected: __Dati_Testo168*/ 
TxtMagazzinoGestitoDestinazione_SvincolatoSede: string;
/** Reflected: __Dati_Testo169*/ 
TxtMagazzinoGestitoOrigine_SvincolatoSede: string
}