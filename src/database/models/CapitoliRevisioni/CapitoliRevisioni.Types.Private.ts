export interface ICapitoliRevisioniPrivate {
  _id: string;
  /** Reflected: IdOfferta*/ 
  ...
  /** Reflected: TitoloCapitolo*/ 
  __Dati_Testo003: string;
  /** Reflected: SottoTitoloCapitolo*/ 
  ...
  /** Reflected: FlagInTotale*/ 
  __Dati_Numero010: number;
  /** Reflected: FlagInTotaleVedi*/ 
  ...
  /** Reflected: VProvvigioniDefinitivo*/ 
  __Dati_Numero019: number;
  /** Reflected: VCostiDefinitivo*/ 
