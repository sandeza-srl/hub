...
import type { ICapitoliRevisioniPrivate } from './CapitoliRevisioni.Types.Private';


/* --------
* Schema Definition
* -------- */
const CapitoliRevisioniSchema = new mongoose.Schema<ICapitoliRevisioniPrivate>({
...
* Module Exports
* -------- */
export default CapitoliRevisioniSchema;