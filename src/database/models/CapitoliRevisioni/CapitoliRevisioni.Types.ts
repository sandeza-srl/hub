export interface ICapitoliRevisioni {
  _id: string;
  ...
  VProvvigioniDefinitivo: number;
  /** Reflected: __Dati_Numero020*/ 
  VCostiDefinitivo: number;
