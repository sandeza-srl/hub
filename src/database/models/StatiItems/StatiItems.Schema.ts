...
import type { IStatiItemsPrivate } from './StatiItems.Types.Private';


/* --------
* Schema Definition
* -------- */
const StatiItemsSchema = new mongoose.Schema<IStatiItemsPrivate>({
  ...
  __Dati_Testo008: {
    type: String,
    alias: 'TxtOrdinamentoStatoItemsAutomatico',
...
* Module Exports
* -------- */
export default StatiItemsSchema;