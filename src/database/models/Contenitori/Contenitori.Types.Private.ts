export interface IContenitoriPrivate {
  _id: string;
  ...
  /** Reflected: TxtTipoStatoContenitore*/ 
  ...
  /** Reflected: IdTipoStatoContenitore*/ 
  ...
  /** Reflected: TxtFamigliaContenitore*/ 
  ...
  /** Reflected: TxtTipoStatoContenitoreAutomatico*/ 
  ...
  /** Reflected: CodiceTxtContenitoreAutomatico*/ 
