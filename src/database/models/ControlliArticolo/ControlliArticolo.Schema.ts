...
import type { IControlliArticoloPrivate } from './ControlliArticolo.Types.Private';


/* --------
* Schema Definition
* -------- */
const ControlliArticoloSchema = new mongoose.Schema<IControlliArticoloPrivate>({
...
__Dati_Numero019: {
type: Number,
alias: 'FlagAggiornaContenutiDaTipiControlli',

},
__Dati_Numero020: {
type: Number,
alias: 'FlagAggiornaContenutiDaTipiPianoCampionamento',
...
* Module Exports
* -------- */
export default ControlliArticoloSchema;