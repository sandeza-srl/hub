export interface IFornitureItems {
_id: string;
...
VAcquistoUmItem: number;
/** Reflected: __Dati_Data001*/ 
DataCostoAcquisto: Date;
/** Reflected: __Dati_Numero003*/ 
VAcquistoUmItemPrecedente: number;
/** Reflected: __Dati_Numero004*/ 
DifferenzaCostoPercentuale: number;
/** Reflected: __Dati_Data002*/ 
DataCostoAcquistoPrecedente: Date;
...
IdRubricaCommerciale: string;
/** Reflected: __Dati_Testo009*/ 
IdRubricaTecnico: string;
...
NomeRubricaCommerciale: string;
/** Reflected: __Dati_Testo013*/ 
NomeRubricaTecnico: string;
...
VariazioneDiretta: number;
/** Reflected: __Dati_Numero018*/ 
VAcquistoUmItemDefinitivo: number;
...
VAcquistoUmForListino: number;
/** Reflected: __Dati_Numero022*/ 
VAcquistoUmForDefinitivo: number;
...
FlagCreatoArticoliProduzione: number;
...
VAcquistoUmForDefinitivoValuta: number;
/** Reflected: __Dati_Testo030*/ 
VAcquistoUmItemValuta: string;
...
TxtFornituraItemDataAutomatico: string;
...
Forniture_DaCalcolo_FlagAttiva: number;
/** Reflected: __Dati_Testo041*/ 
Forniture_DaCalcolo_Algoritmo: string;
/** Reflected: __Dati_Numero044*/ 
Forniture_DaCalcolo_FlagAlgoritmoValidato: number;
/** Reflected: __Dati_Numero045*/ 
FlagAggiornaCorrelazioni: number;
/** Reflected: __Dati_Numero046*/ 
FlagFornituraUsataComeFattore: number;
/** Reflected: __Dati_Numero047*/ 
FlagAggiornaContenutiDaSottofamiglieItems: number;
/** Reflected: __Dati_Numero048*/ 
FlagAggiornaDaAltreForniture: number;
/** Reflected: __Dati_Testo042*/ 
Forniture_DaCalcolo_AlgoritmoValorizzato: string;
