export interface IScadenzeDocContabili {
  _id: string;
  ...
  DescrizioneMetodoPagamento: string;
  /** Reflected: __Dati_Testo030*/ 
  DescrizioneMetodoPagamento_LinguaPrincipale: string;
  /** Reflected: __Dati_Testo031*/ 
  DescrizioneRegolaScadenze: string;
  /** Reflected: __Dati_Testo032*/ 
  DescrizioneRegolaScadenze_LinguaPrincipale: string;
  /** Reflected: __Dati_Numero021*/ 
  FlagRibaDaInviare: number;
  /** Reflected: __Dati_Numero022*/ 
  FlagRibaInviata: number;
  /** Reflected: __Dati_Numero023*/ 
  FlagRibaSelezionata: number;
  /** Reflected: __Dati_Numero024*/ 
  FlagRibaBloccata: number;
  /** Reflected: __Dati_Testo033*/ 
  IdLogInvioRiBa: string;
  /** Reflected: __Dati_Numero025*/ 
  ProgressivoRiba: number;
  ...
  VScadenzaValutaSegno: number;
  /** Reflected: __Dati_Numero029*/ 
  VDaPagareValutaSegno: number;
  /** Reflected: __Dati_Numero030*/ 
  NumeroScadenza: number;
  /** Reflected: __Dati_Testo035*/ 
  IdCassaBancaEmittenteAppoggioRiBa: string;
  ...
  FlagRIDBloccato: number;
  /** Reflected: __Dati_Numero034*/ 
  FlagRIDInviato: number;
  /** Reflected: __Dati_Numero035*/ 
  FlagRIDDaInviare: number;
  /** Reflected: __Dati_Numero036*/ 
  FlagRIDSelezionato: number;
  /** Reflected: __Dati_Testo040*/ 
  IdCassaBancaScadenza: string;
