export interface IInterventi {
  ...
  IdOperatoreResponsabile: string;
  ...
  FlagIncassoImmediato: number;
  /** Reflected: __Dati_Testo059*/ 
  IdDocOperativoDdt: string;
  ...
  AnnoSettimanaEsecuzioneProgrammata: number;
  ...
  AnnoMeseScadenzaRichiesta: number;
  /** Reflected: __Dati_Numero035*/ 
  AnnoSettimanaScadenzaRichiesta: number;
  /** Reflected: __Dati_Numero036*/ 
  AnnoEsecuzioneReale: number;
  ...
  AnnoMeseInserimento: number;
  /** Reflected: __Dati_Numero040*/ 
  AnnoSettimanaInserimento: number;
  /** Reflected: __Dati_Numero041*/ 
  FlagAggiornaDatiDocOperativo: number;
  ...
  IdRubricaPagatore: string;
  /** Reflected: __Dati_Testo074*/ 
  IdSedePagatore: string;
  ...
  FlagAggiornaImpostazioni: number;
  /** Reflected: __Dati_Numero045*/ 
  FlagAggiornaIntervento: number;
  /** Reflected: __Dati_Numero046*/ 
  FlagDocOperativoCreato: number;
  /** Reflected: __Dati_Testo078*/ 
  TxtImpianto: string;
  /** Reflected: __Dati_DataOra007*/ 
  DataOraFlagInviato: Date;
  /** Reflected: __Dati_Testo079*/ 
  TxtUtenteFlagInviato: string;
  /** Reflected: __Dati_DataOra008*/ 
  DataOraFlagStatoConfermato: Date;
  /** Reflected: __Dati_DataOra009*/ 
  DataOraFlagStatoControllato: Date;
  /** Reflected: __Dati_Testo080*/ 
  TxtUtenteFlagStatoConfermato: string;
  /** Reflected: __Dati_Testo081*/ 
  TxtUtenteFlagStatoControllato: string;
  /** Reflected: __Dati_Testo082*/ 
  IdDocOperativoOrigineDiretti_Tutti: string;
  /** Reflected: __Dati_Testo083*/ 
  IdTipoDocOperativo_OrigineDati: string;
  /** Reflected: __Dati_Testo084*/ 
  IdAccountIntervento: string;
  /** Reflected: __Dati_Numero047*/ 
  FlagAggiorna01_ValoriImpostazione: number;
  ...
  TotaleVoci_QuantitaOre_03: number;
