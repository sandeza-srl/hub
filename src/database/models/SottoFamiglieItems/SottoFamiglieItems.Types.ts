export interface ISottoFamiglieItems {
  _id: string;
  ...
  GeneraCodiceTracciabilitaAutomatico_AltraSottoFamigliaPerCodice: string;
  /** Reflected: __Dati_Testo012*/ 
  GeneraCodiceTracciabilitaAutomatico_CodiceTest: string;
  /** Reflected: __Dati_Numero029*/ 
  GeneraCodiceTracciabilitaAutomatico_FlagUsaCodiceAltro: number;
  /** Reflected: __Dati_Numero030*/ 
  GeneraCodiceTracciabilitaAutomatico_NumeroCifre: number;
  /** Reflected: __Dati_Numero031*/ 
  GeneraCodiceTracciabilitaAutomatico_OrdineProgressivo: number;
  /** Reflected: __Dati_Numero032*/ 
  GeneraCodiceTracciabilitaAutomatico_OrdineTesto: number;
  /** Reflected: __Dati_Numero033*/ 
  GeneraCodiceTracciabilitaAutomatico_Progressivo: number;
  /** Reflected: __Dati_Testo013*/ 
  GeneraCodiceTracciabilitaAutomatico_Testo: string;
  ...
  GeneraCodiceTracciabilitaAutomatico_OrdineAnno: number;
  /** Reflected: __Dati_Numero037*/ 
  GeneraCodiceTracciabilitaAutomatico_Anno: number;
  /** Reflected: __Dati_Testo014*/ 
  GeneraCodiceTracciabilitaAutomatico_StringaControlloCodice: string;
  ...
  GeneraCodiceItem_CodiceEsempio: string;
  /** Reflected: __Dati_Testo017*/ 
  GeneraCodiceItem_Espressione: string;
  /** Reflected: __Dati_Testo018*/ 
  GeneraCodiceTracciabilitaAutomatico_HelpIdFamigliaItemPerCodice: string;
  /** Reflected: __Dati_Numero039*/ 
  GeneraCodiceItem_FlagTipoCodice_AltraSottofamiglia: number;
  /** Reflected: __Dati_Numero040*/ 
  GeneraCodiceItem_FlagTipoCodice_Standard: number;
  /** Reflected: __Dati_Testo019*/ 
  GeneraCodiceTracciabilitaAutomatico_CodiceEsempio: string;
  /** Reflected: __Dati_Testo020*/ 
  GeneraCodiceTracciabilitaAutomatico_Espressione: string;
  /** Reflected: __Dati_Testo021*/ 
  GeneraCodiceItem_AltroIdSottoFamigliaItemPerCodice: string;
  /** Reflected: __Dati_Numero041*/ 
  GeneraCodiceItem_FlagCodiceValidato: number;
  /** Reflected: __Dati_Numero042*/ 
  GeneraCodiceItem_FlagTipoCodice_Proprio: number;
  /** Reflected: __Dati_Numero043*/ 
  GeneraCodiceItem_FlagModificaCodicePermessa: number;
  /** Reflected: __Dati_Numero044*/ 
  GeneraCodiceItem_FlagProgressivoAnnuale: number;
  /** Reflected: __Dati_Numero045*/ 
  GeneraCodiceItem_FlagProgressivoContinuo: number;
  /** Reflected: __Dati_Numero046*/ 
  GeneraCodiceItem_FlagProgressivoMensile: number;
  /** Reflected: __Dati_Numero047*/ 
  FlagControlloImpostazioni_TipiRicaviSpese: number;
  /** Reflected: __Dati_Numero048*/ 
  FlagControlloImpostazioni_Aggiorna: number;
  /** Reflected: __Dati_Numero049*/ 
  FlagControlloImpostazioni_TipiInformazioniItems: number;
  /** Reflected: __Dati_Numero050*/ 
  FlagControlloImpostazioni_DatiGenerali: number;
  /** Reflected: __Dati_Numero051*/ 
  FlagControlloImpostazioni_Valorizzazione: number;
  /** Reflected: __Dati_Numero052*/ 
  FlagTracciabilitaNecessaria: number;
  /** Reflected: __Dati_Testo022*/ 
  GeneraCodiceItem_TxtTipoCodice: string;
  /** Reflected: __Dati_Testo023*/ 
  ClassePosizioneMagazzino: string;
  /** Reflected: __Dati_Numero053*/ 
  FlagEliminaCodificheClienteConRevPermessa: number;
  /** Reflected: __Dati_Testo024*/ 
  JSON_ImpostazioniSottofamiglia: string;
  /** Reflected: __Dati_Numero054*/ 
  Cruscotto_FlagEscludi: number;
  /** Reflected: __Dati_Testo025*/ 
  DescrizioneItem_Esempio: string;
  /** Reflected: __Dati_Testo026*/ 
  DescrizioneItem_Calcolo: string;
