...
CodificaClienteItemClienteOfferta_DescrizioneItemCliente: string;
/** Reflected: __Dati_Testo063*/ 
CodificaClienteItemClienteOfferta_CodiceItemCliente: string;
/** Reflected: __Dati_Testo064*/ 
CodificaClienteItemClienteOfferta_NumeroRevisione: string;
/** Reflected: __Dati_Numero130*/ 
Scaglione_CostoRiclassificato_CTMSpT_Buy: number;
/** Reflected: __Dati_Numero131*/ 
Scaglione_CostoRiclassificato_CUMSpT_Buy: number;
...
FlagAggiornaNumeroDecimaliValori: number
}