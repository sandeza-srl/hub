export interface IImpianti {
  ...
  IdRubricaProduttoreTecnico: string;
  /** Reflected: __Dati_Testo007*/ 
  NomeRubricaProduttoreTecnico: string;
  ...
  TxtOperatoreInstallatore: string;
  ...
  NomeRubricaClienteFinaleTecnico: string;
  /** Reflected: __Dati_Testo020*/ 
  IdRubricaClienteFinaleTecnico: string;
  ...
  FlagGestitoVedi: string;
  /** Reflected: __Dati_Testo030*/ 
  FlagGestitoTxt: string;
  /** Reflected: __Dati_Testo031*/ 
  IdRubricaProduttoreCommerciale: string;
  /** Reflected: __Dati_Testo032*/ 
  IdRubricaClienteFinaleCommerciale: string;
  /** Reflected: __Dati_Testo033*/ 
  NomeRubricaClienteFinaleCommerciale: string;
  /** Reflected: __Dati_Testo034*/ 
  NomeRubricaProduttoreCommerciale: string;
  /** Reflected: __Dati_Testo035*/ 
  TxtOperatoreCommerciale: string;
