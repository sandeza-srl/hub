export interface IPeriodiChiusuraPrivate {
  ...
  /** Reflected: SettimaneChiusura*/ 
  __Dati_Numero003: number;
  /** Reflected: IdItem*/ 
  __Dati_Testo004: string;
  /** Reflected: AnnoSettimanaInizioChiusura*/ 
  __Dati_Numero004: number;
  /** Reflected: AnnoSettimanaFineChiusura*/ 
  ...
  /** Reflected: AnnoSettimaneChiusura*/ 
  __Dati_Testo007: string;
  /** Reflected: GiorniChiusura*/ 
