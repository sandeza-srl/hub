...
import type { IInformazioniOffertePrivate } from './InformazioniOfferte.Types.Private';


/* --------
* Schema Definition
* -------- */
const InformazioniOfferteSchema = new mongoose.Schema<IInformazioniOffertePrivate>({
...
__Dati_Testo014: {
type: String,
alias: 'TxtValoreInformazioniOfferta_LinguaPredefinita',

},
__Dati_Testo015: {
type: String,
alias: 'TxtValoreInformazioniOfferta_InLinguaOfferta',
...
* Module Exports
* -------- */
export default InformazioniOfferteSchema;