export interface IInformazioniOffertePrivate {
_id: string;
/** Reflected: IdOfferta*/ 
...
/** Reflected: TxtValoreInformazioniOfferta_LinguaPredefinita*/ 
__Dati_Testo014: string;
/** Reflected: TxtValoreInformazioniOfferta_InLinguaOfferta*/ 
