export interface IContiStatoPatrimoniale {
_id: string;
...
IdContoStatoPatrimoniale: string;
/** Reflected: __Dati_Testo005*/ 
TxtTipoContoStatoPatrimoniale: string;
...
IdTipoContoStatoPatrimoniale: string;
...
CodiceTipoContoStatoPatrimoniale: string;
