export interface IOfferteTestateRevisioni {
_id: string;
...
FlagAccettataVedi: string;
/** Reflected: __Dati_Testo024*/ 
FlagRifiutataVedi: string;
...
IdOffertaTestateRevisioni: string;
