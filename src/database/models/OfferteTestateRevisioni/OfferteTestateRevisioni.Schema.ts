...
import type { IOfferteTestateRevisioniPrivate } from './OfferteTestateRevisioni.Types.Private';


/* --------
* Schema Definition
* -------- */
const OfferteTestateRevisioniSchema = new mongoose.Schema<IOfferteTestateRevisioniPrivate>({
  ...
  __Dati_Testo061: {
    type: String,
    alias: 'IdOffertaTestateRevisioni',
...
* Module Exports
* -------- */
export default OfferteTestateRevisioniSchema;