export interface IOpzioniProd {
  ...
  CHF_T_Risorsa: number;
  /** Reflected: __Dati_Numero016*/ 
  CHP_T_Risorsa: number;
  ...
  Pianificazione_FlagAttesaTotale: number;
  /** Reflected: __Dati_Numero074*/ 
  Pianificazione_HAttesa: number;
  /** Reflected: __Dati_Numero075*/ 
  FlagAggiornaDaControlli: number;
  /** Reflected: __Dati_Numero076*/ 
  NumeroControlliOpzione: number;
  ...
  IdDocImgProgrammiMacchina: string;
  /** Reflected: __Dati_Numero079*/ 
  QtPerImballo: number;
  /** Reflected: __Dati_Ora004*/ 
  TempoColpo_T: string;
  /** Reflected: __Dati_Testo042*/ 
  CodiceTxtRisorsaNumeroAlternativaAutomatico: string;
  ...
  FlagAlertNoteAttrezzaggio: number;
  /** Reflected: __Dati_Numero099*/ 
  FlagAlertNoteMovimentazione: number;
  /** Reflected: __Dati_Numero100*/ 
  FlagAlertNoteProduzione: number;
  /** Reflected: __Dati_Numero101*/ 
  FlagAlertNoteImballo: number;
  /** Reflected: __Dati_Numero102*/ 
  FlagAlertNoteUtensili: number;
  /** Reflected: __Dati_Numero103*/ 
  FlagAlertNoteQualita: number;
  ...
  FlagTempiVerificati: number;
  /** Reflected: __Dati_Testo047*/ 
  TxtUtenteVerificaTempi: string;
  /** Reflected: __Dati_DataOra003*/ 
  DataOraVerificaTempi: Date;
  /** Reflected: __Dati_Testo048*/ 
  CodiceTxtItemLavorazione: string;
  /** Reflected: __Dati_Numero106*/ 
  MinutiColpo_T: number;
  /** Reflected: __Dati_Numero107*/ 
  MinutiUmOpz_T: number;
  /** Reflected: __Dati_Numero108*/ 
  NumeroItemsOpzioneProd: number;
