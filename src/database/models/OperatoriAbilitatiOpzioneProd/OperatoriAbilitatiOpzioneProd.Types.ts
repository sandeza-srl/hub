export interface IOperatoriAbilitatiOpzioneProd {
_id: string;
...
IdAbilitazioneOperatore: string;
...
AbilitaAttrezzaggioTxtOperatoreAutomatico: string;
...
FlagPredefinitoProduzione: number;
/** Reflected: __Dati_Numero004*/ 
AbilitaProduzione: number;
/** Reflected: __Dati_Testo014*/ 
AbilitaProduzioneTxtOperatoreAutomatico: string;
/** Reflected: __Dati_Testo015*/ 
IdOperatoreProduzione: string;
/** Reflected: __Dati_Numero005*/ 
AbilitaAttrezzaggio: number;
/** Reflected: __Dati_Numero006*/ 
FlagPredefinitoAttrezzaggio: number;
...
FlagAssegnaAutomaticamente: number;
