export interface IOperatoriGruppiLavoro {
_id: string;
...
IdOperatoreGruppoLavoro: string;
...
IdTipoRuoloTipoGruppoLavoro: string;
/** Reflected: __Dati_Testo008*/ 
TxtTipoRuolo: string;
/** Reflected: __Dati_Numero004*/ 
FlagResponsabile: number;
