export interface IOperatoriGruppiLavoroPrivate {
  _id: string;
  ...
  /** Reflected: IdOperatoreGruppoLavoro*/ 
  ...
  /** Reflected: IdTipoRuoloTipoGruppoLavoro*/ 
  __Dati_Testo007: string;
  /** Reflected: TxtTipoRuolo*/ 
  __Dati_Testo008: string;
  /** Reflected: FlagResponsabile*/ 
