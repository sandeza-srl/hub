export interface IRicaviSpesePeriodoDocOperativi {
_id: string;
...
IdRicavoSpesaPeriodoOrigine: string;
/** Reflected: __Dati_Numero028*/ 
PercentualeVImponibileVoce: number;
...
OrdineDescrizioneVoceAutomatica: string
}