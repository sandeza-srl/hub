...
IdItemArticoloFaseProduzione: string;
...
FasiProduzione_FabbMateriale_IdItemOpzioneProd: string;
...
FasiProduzione_FabbMateriale_QtPerUmOpzioneProd: number;
...
UnitaMisuraItemAlternativa: string;
/** Reflected: __Dati_Numero166*/ 
QuantitaItemAlternativa: number;
/** Reflected: __Dati_Numero167*/ 
ConversioneUmDaUmAlternativaAItem: number;
/** Reflected: __Dati_Numero168*/ 
ConversioneUmDaItemAUmAlternativa: number;
/** Reflected: __Dati_Numero169*/ 
FasiProduzione_LavEsterna_ConvUmLavorazioneUmOpz: number;
/** Reflected: __Dati_Numero170*/ 
FasiProduzione_LavEsterna_ConvUmOpzUmLavorazione: number;
/** Reflected: __Dati_Testo119*/ 
FasiProduzione_UmOpzione: string;
/** Reflected: __Dati_Testo120*/ 
FasiProduzione_UmFinito: string;
/** Reflected: __Dati_Numero171*/ 
FasiProduzione_ConvUmFinUmOpz: number;
/** Reflected: __Dati_Numero172*/ 
FasiProduzione_ConvUmOpzUmFin: number;
/** Reflected: __Dati_Numero173*/ 
FasiProduzione_FlagAggiornaContenutiDaFaseProduzione: number;
/** Reflected: __Dati_Numero174*/ 
FasiProduzione_QT_Tt_Opz: number;
/** Reflected: __Dati_Testo121*/ 
Logistica_PesoLordo: string;
/** Reflected: __Dati_Testo122*/ 
Logistica_PesoNetto: string;
/** Reflected: __Dati_Testo123*/ 
Logistica_Tara: string;
/** Reflected: __Dati_Testo124*/ 
Logistica_NumeroColli: string;
/** Reflected: __Dati_Testo125*/ 
Integrazione_DatiVariAC: string;
/** Reflected: __Dati_Numero175*/ 
InserimentoInCompetenze_FlagCompleto: number;
/** Reflected: __Dati_Numero176*/ 
InserimentoInCompetenze_VImponibileResiduo: number;
/** Reflected: __Dati_Numero177*/ 
InserimentoInCompetenze_VImponibileScaricato: number;
/** Reflected: __Dati_Numero178*/ 
InserimentoInCompetenze_FlagVoceSelezionata: number;
...
CodiceItemCliente_Destinatario: string;
/** Reflected: __Dati_Testo129*/ 
CodiceItemClienteRevisioneAutomatico_Destinatario: string;
/** Reflected: __Dati_Data011*/ 
DataRevisioneCodiceItemCliente_Destinatario: Date;
/** Reflected: __Dati_Testo130*/ 
DescrizioneItemCliente_Destinatario: string;
/** Reflected: __Dati_Testo131*/ 
NumeroRevisioneCodiceItemCliente_Destinatario: string;
/** Reflected: __Dati_Testo132*/ 
Tipo_FlagTipoLista: string
}