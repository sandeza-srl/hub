...
ValoreVoci_Aggiornamento_FlagSenzaAttesa: number;
...
LimitazioniScheda_Creazione_IdTipiRuoliAbilitati: string;
/** Reflected: __Dati_Testo051*/ 
LimitazioniScheda_AccessoScheda_IdTipiRuoliAbilitati: string;
/** Reflected: __Dati_Testo052*/ 
LimitazioniScheda_VisibilitaValoriEconomici_IdTipiRuoliAbilitati: string;
...
FlagAggiornaDaDocOperativi: number;
/** Reflected: __Dati_Numero129*/ 
NumeroDocOperativiPerTipoDocOperativo: number;
