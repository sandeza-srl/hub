export interface ISoggettiComunicazioni {
  _id: string;
  /** Reflected: __Dati_Numero001*/ 
  FlagA: number;
  /** Reflected: __Dati_Testo001*/ 
  IdComunicazioneAnagrafica: string;
  ...
  IdSoggettoComunicazione: string
}