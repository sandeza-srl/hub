export interface IVociOfferteAppoggio {
  _id: string;
  ...
  IdNuovaVoceOfferta: string;
  /** Reflected: __Dati_Testo013*/ 
  IdNuovoCapitoloOfferta: string;
  /** Reflected: __Dati_Testo014*/ 
  IdNuovaVoceOffertaPadre: string;
