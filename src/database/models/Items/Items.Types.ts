...
Tracciabilita_Tipo_FlagTaglia: number;
/** Reflected: __Dati_Testo029*/ 
IdItemOrigine: string;
/** Reflected: __Dati_Numero036*/ 
Tracciabilita_Tipo_FlagInfoExtra: number;
...
Tracciabilita_Tipo_FlagColore: number;
...
Tracciabilita_Tipo_FlagNumeroSerie: number;
...
ScaricoProduzione_FlagDeduzioneAutomatica: number;
/** Reflected: __Dati_Numero277*/ 
ScaricoProduzione_FlagQtProposta: number;
...
Tracciabilita_FlagTracciabilitaNecessaria: number;
...
StatiItem_FlagItemOrdinato: number;
/** Reflected: __Dati_Numero329*/ 
StatiItem_FlagItemFabbisogno: number;
/** Reflected: __Dati_Numero330*/ 
StatiItem_FlagItemEntrata: number;
/** Reflected: __Dati_Numero331*/ 
StatiItem_FlagItemUscita: number;
/** Reflected: __Dati_Numero332*/ 
StatiItem_FlagItemRichiestoOrdineApprovvigionamento: number;
/** Reflected: __Dati_Numero333*/ 
StatiItem_FlagNovita: number;
...
Pianificazione_FlagItemVincolante: number;
/** Reflected: __Dati_Numero353*/ 
FlagTipoSottoprodottoLavorazione: number;
/** Reflected: __Dati_Numero354*/ 
Sottoprodotti_FlagItemSottoprodotto: number;
/** Reflected: __Dati_Numero355*/ 
Sottoprodotti_FlagItemConSottoprodotti: number;
/** Reflected: __Dati_Testo086*/ 
TxtStatoItem: string;
/** Reflected: __Dati_Testo087*/ 
TxtOrdinamentoStatoItemAutomatico: string;
/** Reflected: __Dati_Numero356*/ 
DragDrop_ImmagineIdentificativa_FlagAttivato: number;
...
Tracciabilita_DedottaAutomaticamente_FlagPossibile: number;
/** Reflected: __Dati_Testo091*/ 
Integrazione_DatiVariAC: string;
/** Reflected: __Dati_Numero359*/ 
Qt_FlagItemInRicalcolo: number;
/** Reflected: __Dati_Numero360*/ 
Tracciabilita_Tipo_FlagRegistrazioneFaseProduzione: number;
/** Reflected: __Dati_Numero361*/ 
QtRichiestoApprovigionamento_DOp_Sett00: number;
/** Reflected: __Dati_Numero362*/ 
QtRichiestoApprovigionamento_DOp_Sett01: number;
/** Reflected: __Dati_Numero363*/ 
QtRichiestoApprovigionamento_DOp_Sett02: number;
/** Reflected: __Dati_Numero364*/ 
QtRichiestoApprovigionamento_DOp_Sett03: number;
/** Reflected: __Dati_Numero365*/ 
QtRichiestoApprovigionamento_DOp_Sett04: number;
/** Reflected: __Dati_Numero366*/ 
QtRichiestoApprovigionamento_DOp_Sett05: number;
/** Reflected: __Dati_Numero367*/ 
QtRichiestoApprovigionamento_DOp_Sett06: number;
/** Reflected: __Dati_Numero368*/ 
QtRichiestoApprovigionamento_DOp_Sett07: number;
/** Reflected: __Dati_Numero369*/ 
QtRichiestoApprovigionamento_DOp_Sett08: number;
/** Reflected: __Dati_Numero370*/ 
QtRichiestoApprovigionamento_DOp_Sett09: number;
/** Reflected: __Dati_Numero371*/ 
QtRichiestoApprovigionamento_DOp_Sett10: number;
/** Reflected: __Dati_Numero372*/ 
QtRichiestoApprovigionamento_DOp_Sett11: number;
/** Reflected: __Dati_Numero373*/ 
QtRichiestoApprovigionamento_DOp_Sett12: number;
/** Reflected: __Dati_Numero374*/ 
QtRichiestoApprovigionamento_DOp_SettOltre12: number
}