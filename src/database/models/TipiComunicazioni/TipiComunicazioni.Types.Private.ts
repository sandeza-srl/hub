export interface ITipiComunicazioniPrivate {
_id: string;
/** Reflected: Uno*/ 
...
/** Reflected: FlagSelezioneTipo*/ 
__Dati_Testo007: string;
/** Reflected: FlagTipoFatture*/ 
