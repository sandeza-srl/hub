...
__Dati_Testo029: {
type: String,
alias: 'IdDocumentoPrincipaleRubrica',

},
__Dati_Numero015: {
type: Number,
alias: 'FlagInvioDocumentiTecnici',
...
__Dati_Numero016: {
type: Number,
alias: 'Newsletter_FlagAbilitazionePossibile',

},
__Dati_Numero017: {
type: Number,
alias: 'Newsletter_Disiscrizione_FlagDisiscritto',

},
__Dati_Data004: {
type: Date,
alias: 'Newsletter_Disiscrizione_DataDisiscrizione',
set: (value: any) => {
 return DateConverter.convertDate(value);
}
},
__Dati_Numero018: {
type: Number,
alias: 'Newsletter_FlagInvioPossibile',
