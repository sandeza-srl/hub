export interface IControlliDocContabili {
  _id: string;
  ...
  FlagTotaliDocContabile: number;
  /** Reflected: __Dati_Numero002*/ 
  FlagScadenze: number;
  /** Reflected: __Dati_Numero003*/ 
  FlagVociDocContabile: number;
  /** Reflected: __Dati_Numero004*/ 
  FlagDatiGenerali: number;
