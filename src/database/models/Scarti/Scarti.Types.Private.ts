export interface IScartiPrivate {
  _id: string;
  /** Reflected: Anno*/ 
  ...
  /** Reflected: TipologiaScartoProduzione*/ 
  __Dati_Testo029: string;
  /** Reflected: CodiceTipoScartoProduzione*/ 
  __Dati_Testo030: string;
  /** Reflected: FlagScartoMateriale*/ 
  ...
  /** Reflected: IdLottoProduzioneRilavorazione*/ 
  __Dati_Testo041: string;
  /** Reflected: CodiceTxtRisorsaAutomatico*/ 
  __Dati_Testo042: string;
  /** Reflected: IdRegistrazioneFaseProduzione_Tutti*/ 
  ...
  /** Reflected: IdFaseProduzioneCompetenza*/ 
  __Dati_Testo051: string;
  /** Reflected: IdRegistrazioneFaseProduzioneCompetenza*/ 
  ...
  /** Reflected: CodiceTxtTipoScartoProduzioneAutomatico*/ 
