...
Avanzamento_TxtStatoFaseProduzione: string;
...
FlagDaBenestariareQualita: number;
...
FlagBenestareQualitaDato: number;
/** Reflected: __Dati_DataOra003*/ 
DataOraBenestareQualita: Date;
/** Reflected: __Dati_Testo081*/ 
IdAccountOperatoreBenestareQualita: string;
/** Reflected: __Dati_Testo082*/ 
TxtAccountOperatoreBenestareQualita: string;
...
NUmFinColpo_T: number;
/** Reflected: __Dati_Numero340*/ 
NUmOpzColpo_T: number;
/** Reflected: __Dati_Numero341*/ 
ModifichePosteriori_FlagFaseCreataPosteriori: number;
/** Reflected: __Dati_Testo104*/ 
ModifichePosteriori_IdUtenteCreazione: string;
/** Reflected: __Dati_Testo105*/ 
ModifichePosteriori_TxtUtenteCreazione: string;
/** Reflected: __Dati_DataOra007*/ 
ModifichePosteriori_DataOraCreazione: Date;
/** Reflected: __Dati_Numero342*/ 
ModifichePosteriori_FlagFaseModificataPosteriori: number;
/** Reflected: __Dati_Testo106*/ 
ModifichePosteriori_IdUtenteModificaSequenza: string;
/** Reflected: __Dati_Testo107*/ 
ModifichePosteriori_TxtUtenteModificaSequenza: string;
/** Reflected: __Dati_DataOra008*/ 
ModifichePosteriori_DataOraModificaSequenza: Date;
/** Reflected: __Dati_Numero343*/ 
ModifichePosteriori_FlagFaseModificataSequenza: number;
/** Reflected: __Dati_Numero344*/ 
Performance_TriggerAggiornamentoRelazione: number;
/** Reflected: __Dati_Testo108*/ 
ProgrammaMacchina_LogErrori: string;
...
BenestareProduzione_FlagAggiornaDaTipiRighe: number;
/** Reflected: __Dati_Numero347*/ 
BenestareProduzione_FlagVisibileRaccoltaDati: number;
/** Reflected: __Dati_Numero348*/ 
QP_R_Prog_Opz: number;
/** Reflected: __Dati_Numero349*/ 
QP_R_Prog_Fin: number;
/** Reflected: __Dati_Numero350*/ 
ContatoreRegistrazioniFaseProduzione: number;
/** Reflected: __Dati_Numero351*/ 
QP_Tf_Opz: number;
/** Reflected: __Dati_Numero352*/ 
QP_Tf_Fin: number;
/** Reflected: __Dati_Numero353*/ 
CTAD_Tf: number;
/** Reflected: __Dati_Numero354*/ 
CTBFc_Tf: number;
/** Reflected: __Dati_Numero355*/ 
CTF_Tf: number;
/** Reflected: __Dati_Numero356*/ 
CTL_Tf: number;
/** Reflected: __Dati_Numero357*/ 
CTLE_Tf: number;
/** Reflected: __Dati_Numero358*/ 
CTM_Tf: number;
/** Reflected: __Dati_Numero359*/ 
CTP_Tf: number;
/** Reflected: __Dati_Numero360*/ 
CTQ_Tf: number;
/** Reflected: __Dati_Numero361*/ 
CTS_Tf: number;
/** Reflected: __Dati_Numero362*/ 
CTSfc_Tf: number;
/** Reflected: __Dati_Numero363*/ 
CTSFp_Tf: number;
/** Reflected: __Dati_Numero364*/ 
CTTRA_Tf: number;
/** Reflected: __Dati_Numero365*/ 
CTUt_Tf: number;
/** Reflected: __Dati_Numero366*/ 
CTT_Tf: number;
/** Reflected: __Dati_Numero367*/ 
CTT_Tf_Totale: number;
/** Reflected: __Dati_DataOra009*/ 
DataOraUltimoAggiornamentoFase: Date;
/** Reflected: __Dati_Numero368*/ 
CUAD_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero369*/ 
CUBfc_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero370*/ 
CUF_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero371*/ 
CUL_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero372*/ 
CULE_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero373*/ 
CUM_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero374*/ 
CUP_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero375*/ 
CUQ_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero376*/ 
CUSFc_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero377*/ 
CUTRA_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero378*/ 
CUUt_R_Fin_Cumulato: number;
/** Reflected: __Dati_Numero379*/ 
CUAD_Tf_Fin: number;
/** Reflected: __Dati_Numero380*/ 
CUAD_Tf_Opz: number;
/** Reflected: __Dati_Numero381*/ 
CUBfc_Tf_Opz: number;
/** Reflected: __Dati_Numero382*/ 
CUBfc_Tf_Fin: number;
/** Reflected: __Dati_Numero383*/ 
CUF_Tf_Fin: number;
/** Reflected: __Dati_Numero384*/ 
CUF_Tf_Opz: number;
/** Reflected: __Dati_Numero385*/ 
CUL_Tf_Opz: number;
/** Reflected: __Dati_Numero386*/ 
CUL_Tf_Fin: number;
/** Reflected: __Dati_Numero387*/ 
CULE_Tf_Fin: number;
/** Reflected: __Dati_Numero388*/ 
CULE_Tf_Opz: number;
/** Reflected: __Dati_Numero389*/ 
CUM_Tf_Opz: number;
/** Reflected: __Dati_Numero390*/ 
CUM_Tf_Fin: number;
/** Reflected: __Dati_Numero391*/ 
CUP_Tf_Fin: number;
/** Reflected: __Dati_Numero392*/ 
CUP_Tf_Opz: number;
/** Reflected: __Dati_Numero393*/ 
CUQ_Tf_Opz: number;
/** Reflected: __Dati_Numero394*/ 
CUQ_Tf_Fin: number;
/** Reflected: __Dati_Numero395*/ 
CUSFc_Tf_Fin: number;
/** Reflected: __Dati_Numero396*/ 
CUSFc_Tf_Opz: number;
/** Reflected: __Dati_Numero397*/ 
CUT_Tf_Opz: number;
/** Reflected: __Dati_Numero398*/ 
CUT_Tf_Fin: number;
/** Reflected: __Dati_Numero399*/ 
CUTRA_Tf_Fin: number;
/** Reflected: __Dati_Numero400*/ 
CUTRA_Tf_Opz: number;
/** Reflected: __Dati_Numero401*/ 
CUUt_Tf_Opz: number;
/** Reflected: __Dati_Numero402*/ 
CUUt_Tf_Fin: number;
/** Reflected: __Dati_Numero403*/ 
TracciabilitaRegistrazione_FlagFaseDiPartenza: number;
/** Reflected: __Dati_Numero404*/ 
TracciabilitaRegistrazione_FlagPresente: number;
/** Reflected: __Dati_Testo110*/ 
TracciabilitaRegistrazione_IdRegistrazioneOrigine: string;
/** Reflected: __Dati_Numero405*/ 
TracciabilitaRegistrazione_FlagVisibileRaccoltaDati: number;
