export interface ICostBreakdownVociOfferte {
_id: string;
...
Fornitura_Utensili_FlagAcquisto: number;
...
Fornitura_Trasporto_FlagAcquisto: number;
/** Reflected: __Dati_Numero056*/ 
Fornitura_Lavorazioni_FlagAcquisto: number;
/** Reflected: __Dati_Testo023*/ 
Fornitura_IdFornituraItem: string;
...
Fornitura_VAcquistoUnitario: number;
...
Fornitura_FlagAggiornaDaFornitura: number;
