...
import type { ICostBreakdownVociOffertePrivate } from './CostBreakdownVociOfferte.Types.Private';


/* --------
* Schema Definition
* -------- */
const CostBreakdownVociOfferteSchema = new mongoose.Schema<ICostBreakdownVociOffertePrivate>({
...
__Dati_Testo035: {
type: String,
alias: 'IdCostBreakdownVoceOfferta',
...
* Module Exports
* -------- */
export default CostBreakdownVociOfferteSchema;