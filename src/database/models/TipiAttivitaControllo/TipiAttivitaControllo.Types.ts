export interface ITipiAttivitaControllo {
_id: string;
...
TempoCheckPrevisto: string;
/** Reflected: __Dati_Testo006*/ 
CodiceRevisione: string;
/** Reflected: __Dati_Contenitore001*/ 
ImmagineOggettoTipoAttivita: string;
...
TxtTipoAttivitaControlloEstesa: string;
/** Reflected: __Dati_Testo014*/ 
IdRegolaRipetizione: string;
...
CodiceTxtTipoArticolo: string;
/** Reflected: __Dati_Testo063*/ 
CodiceTxtSottoFamigliaItem: string;
/** Reflected: __Dati_Testo064*/ 
CodiceTxtTipoAttivitaControllo: string;
/** Reflected: __Dati_Testo065*/ 
CodiceTxtTipoContenitore: string;
/** Reflected: __Dati_Testo066*/ 
CodiceTxtTipoDocOperativo: string;
/** Reflected: __Dati_Testo067*/ 
CodiceTxtTipoImpianto: string;
/** Reflected: __Dati_Testo068*/ 
CodiceTxtTipologiaAccount: string;
/** Reflected: __Dati_Testo069*/ 
CodiceTxtTipoStrumento: string;
/** Reflected: __Dati_Testo070*/ 
CodiceTxtTipoUtensile: string;
/** Reflected: __Dati_Testo071*/ 
CodiceOggettoTipoAttivitaAutomatico: string;
/** Reflected: __Dati_Testo072*/ 
CodiceTxtOggettoTipoAttivitaAutomatico: string;
/** Reflected: __Dati_Testo073*/ 
IdInstallazione: string;
/** Reflected: __Dati_Numero018*/ 
VincoliTipoAccesso_FlagCreabile_Mobile: number;
/** Reflected: __Dati_Numero019*/ 
VincoliTipoAccesso_FlagCreabile_StazioneRaccoltaDati: number;
/** Reflected: __Dati_Numero020*/ 
Provenienza_FlagRisorsa: number;
/** Reflected: __Dati_Numero021*/ 
Provenienza_FlagTipoContenitore: number;
/** Reflected: __Dati_Numero022*/ 
Provenienza_FlagItem: number;
/** Reflected: __Dati_Numero023*/ 
Provenienza_FlagTipoDocOperativo: number;
/** Reflected: __Dati_Numero024*/ 
Provenienza_FlagTipologiaAnagrafica: number;
/** Reflected: __Dati_Numero025*/ 
Provenienza_FlagTipoUtensile: number;
/** Reflected: __Dati_Numero026*/ 
Provenienza_FlagTipoImpianto: number;
/** Reflected: __Dati_Numero027*/ 
Provenienza_FlagTipoStrumento: number;
/** Reflected: __Dati_Numero028*/ 
Provenienza_FlagTipoArticolo: number;
/** Reflected: __Dati_Numero029*/ 
Provenienza_FlagProcesso: number;
/** Reflected: __Dati_Numero030*/ 
Provenienza_FlagStepProcesso: number;
/** Reflected: __Dati_Numero031*/ 
Provenienza_FlagSottoFamiglieItems: number;
/** Reflected: __Dati_Numero032*/ 
Provenienza_FlagAnagrafica: number;
/** Reflected: __Dati_Numero033*/ 
VincoliTipoAccesso_FlagVisibile_StazioneRaccoltaDati: number;
/** Reflected: __Dati_Numero034*/ 
VincoliTipoAccesso_FlagCompilabile_StazioneRaccoltaDati: number;
/** Reflected: __Dati_Numero035*/ 
VincoliTipoAccesso_FlagVisibile_Mobile: number;
/** Reflected: __Dati_Numero036*/ 
VincoliTipoAccesso_FlagCompilabile_Mobile: number;
/** Reflected: __Dati_Testo074*/ 
Stampa_NomeScriptStampa: string;
/** Reflected: __Dati_Testo075*/ 
Stampa_NomeScriptSetup: string;
/** Reflected: __Dati_Numero037*/ 
Stampa_FlagSalvaDocumento: number
}