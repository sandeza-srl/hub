export interface ISistemiEsterni {
  _id: string;
  /** Reflected: __Dati_Testo001*/ 
  IdSistemaEsterno: string;
  ...
  TxtSistemaEsterno: string;
  /** Reflected: __Dati_Testo005*/ 
  ServerNomeOIndirizzo: string;
  /** Reflected: __Dati_Testo006*/ 
  ListaFileZAbilitati: string;
  ...
  Token_Validita: number;
  /** Reflected: __Dati_DataOra003*/ 
  Token_DataOraScadenza: Date;
  /** Reflected: __Dati_Numero004*/ 
  FlagChiamateSenzaAttesa: number;
  /** Reflected: __Dati_Numero005*/ 
  FlagNonElaborareTabelleCorrelate: number
}