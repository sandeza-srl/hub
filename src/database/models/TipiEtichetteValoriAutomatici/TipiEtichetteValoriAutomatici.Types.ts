export interface ITipiEtichetteValoriAutomatici {
  _id: string;
  /** Reflected: __Dati_Testo001*/ 
  IdTipoEtichettaValoreAutomatico: string;
  /** Reflected: __Dati_Testo002*/ 
  IdTipoEtichetta: string;
  /** Reflected: __Dati_Testo003*/ 
  IdTipoEtichettaValoreAutomaticoCorrelato: string;
  /** Reflected: __Dati_Testo004*/ 
  IdEtichettaRegola: string;
  /** Reflected: __Dati_Testo005*/ 
  ValoreRegola: string;
  /** Reflected: __Dati_Testo006*/ 
  ValoreAutomaticoRegola: string;
