...
import type { IFamiglieStrumentiPrivate } from './FamiglieStrumenti.Types.Private';


/* --------
* Schema Definition
* -------- */
const FamiglieStrumentiSchema = new mongoose.Schema<IFamiglieStrumentiPrivate>({
...
* Module Exports
* -------- */
export default FamiglieStrumentiSchema;