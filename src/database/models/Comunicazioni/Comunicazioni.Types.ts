export interface IComunicazioni {
  _id: string;
  /** Reflected: __Dati_Testo001*/ 
  CodiceTipoComunicazione: string;
  ...
  FlagInvioDocContabile: number;
  /** Reflected: __Dati_Numero002*/ 
  IntervalloSollecito01_02: number;
  /** Reflected: __Dati_Numero003*/ 
  FlagSollecito01: number;
  /** Reflected: __Dati_Numero004*/ 
  IntervalloSollecito02_03: number;
  /** Reflected: __Dati_Numero005*/ 
  FlagSollecito02: number;
  /** Reflected: __Dati_Testo002*/ 
  TxtSollecitoAutomatico: string;
  /** Reflected: __Dati_Numero006*/ 
  FlagSollecito03: number;
  ...
  IntervalloSollecito00_01: number;
  /** Reflected: __Dati_Numero011*/ 
  FlagValidata: number;
  /** Reflected: __Dati_Data001*/ 
  DataProssimoSollecito: Date;
