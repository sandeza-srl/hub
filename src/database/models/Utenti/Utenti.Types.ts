...
PasswordUtenteVisualizza: string;
...
FlagUtenteWeb: number;
/** Reflected: __Dati_Testo014*/ 
ChatInArrivoUtenti: string;
...
FlagNoteDiReleaseCritica: number;
/** Reflected: __Dati_Numero015*/ 
FlagMultisocieta: number;
/** Reflected: __Dati_Numero016*/ 
TotaleUtenteSocieta: number;
/** Reflected: __Dati_Numero017*/ 
Performance_PrivilegiaEsecuzioneServer: number;
/** Reflected: __Dati_Testo025*/ 
ChiamataTelefonicaViaUrl_Mac: string;
/** Reflected: __Dati_Testo026*/ 
ChiamataTelefonicaViaUrl_Win: string
}