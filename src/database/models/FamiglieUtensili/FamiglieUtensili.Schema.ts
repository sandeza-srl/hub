...
import type { IFamiglieUtensiliPrivate } from './FamiglieUtensili.Types.Private';


/* --------
* Schema Definition
* -------- */
const FamiglieUtensiliSchema = new mongoose.Schema<IFamiglieUtensiliPrivate>({
...
* Module Exports
* -------- */
export default FamiglieUtensiliSchema;