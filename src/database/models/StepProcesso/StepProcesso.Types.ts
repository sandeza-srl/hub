export interface IStepProcesso {
  _id: string;
  ...
  TxtStepProcesso: string;
  /** Reflected: __Dati_Testo004*/ 
  NoteGenerali: string;
  /** Reflected: __Dati_Testo005*/ 
  IdAccountOperatoreResponsabile: string;
  /** Reflected: __Dati_Testo006*/ 
  NomeRubricaOperatoreResponsabile: string;
  /** Reflected: __Dati_Testo007*/ 
  IdRubricaOperatoreResponsabile: string;
  ...
  FlagAllegatiPresenti: number;
  /** Reflected: __Dati_Numero006*/ 
  AnnoInizioPianificato: number;
  ...
  DataOraFineEffettiva: Date;
  /** Reflected: __Dati_Testo035*/ 
  IdAccountOperatoriNotifica: string;
  /** Reflected: __Dati_Testo036*/ 
  IdTipoStepProcessiConnesso: string;
  /** Reflected: __Dati_Numero009*/ 
  Ordine: number;
  /** Reflected: __Dati_Numero010*/ 
  GiorniDaPrecedente: number;
  /** Reflected: __Dati_Testo037*/ 
  TxtAccountOperatoreResponsabile: string;
  ...
  IdSedeSelezionataManuale: string;
  /** Reflected: __Dati_Testo051*/ 
  TxtOrdineStepProcessoAutomatico: string;
  ...
  TxtAccountOperatoriInvitati: string;
  /** Reflected: __Dati_Testo074*/ 
  TxtAccountOperatoriNotifica: string;
  /** Reflected: __Dati_Testo075*/ 
  TxtAccountOperatoriFirma: string;
  /** Reflected: __Dati_Ora007*/ 
  OreEseguite: string;
  /** Reflected: __Dati_Numero018*/ 
  VCostoTotaleOreEseguite: number;
  /** Reflected: __Dati_Testo076*/ 
  IdAccountOperatoriAttiviEvento: string;
