export interface IFamiglieItemPrivate {
  _id: string;
  ...
  /** Reflected: GeneraCodiceItem_CodiceTest*/
  __Dati_Testo007: string;

  /** Reflected: GeneraCodiceItem_FlagTipoCodice_AltraFamiglia*/
  __Dati_Numero007: number;

  /** Reflected: GeneraCodiceItem_NumeroCifre*/
  __Dati_Numero008: number;

  /** Reflected: GeneraCodiceItem_OrdineProgressivo*/
  __Dati_Numero009: number;

  /** Reflected: GeneraCodiceItem_OrdineTesto*/
  __Dati_Numero010: number;

  /** Reflected: GeneraCodiceItem_Progressivo*/
  __Dati_Numero011: number;

  /** Reflected: GeneraCodiceItem_Testo*/
  ...
  /** Reflected: IdTipoMercato*/
  __Dati_Testo014: string;

  /** Reflected: TxtTipoMercato*/
