export interface IFamiglieItem {
  _id: string;
  ...
  GeneraCodiceItem_CodiceTest: string;

  /** Reflected: __Dati_Numero007*/
  GeneraCodiceItem_FlagTipoCodice_AltraFamiglia: number;

  /** Reflected: __Dati_Numero008*/
  GeneraCodiceItem_NumeroCifre: number;

  /** Reflected: __Dati_Numero009*/
  GeneraCodiceItem_OrdineProgressivo: number;

  /** Reflected: __Dati_Numero010*/
  GeneraCodiceItem_OrdineTesto: number;

  /** Reflected: __Dati_Numero011*/
  GeneraCodiceItem_Progressivo: number;

  /** Reflected: __Dati_Testo008*/
  GeneraCodiceItem_Testo: string;
  ...
  IdTipoMercato: string;

  /** Reflected: __Dati_Testo015*/
  TxtTipoMercato: string;
}
