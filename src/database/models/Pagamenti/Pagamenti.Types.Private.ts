export interface IPagamentiPrivate {
_id: string;
...
/** Reflected: AnnoEffettivo*/ 
__Dati_Numero002: number;
/** Reflected: AnnoMeseEffettivo*/ 
__Dati_Testo003: string;
/** Reflected: ConversioneValutaAPrincipale*/ 
__Dati_Numero003: number;
/** Reflected: DataEffettivaPagamento*/ 
__Dati_Data001: Date;
/** Reflected: MeseEffettivo*/ 
__Dati_Numero004: number;
/** Reflected: SettimanaEffettiva*/ 
...
__Dati_Data002: Date;
/** Reflected: IdPagamento*/ 
__Dati_Testo008: string;
/** Reflected: IdCassaBancaPagamento*/ 
...
/** Reflected: TxtCassaBancaPagamento*/ 
