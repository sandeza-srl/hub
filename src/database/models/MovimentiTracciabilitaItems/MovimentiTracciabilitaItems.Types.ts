export interface IMovimentiTracciabilitaItems {
  _id: string;
  ...
  QuantitaResiduaMovimentazione: number;
  /** Reflected: __Dati_Numero005*/ 
  FlagAggiornaDaMovimentiStock: number;
  ...
  TxtAutomaticoDocOperativoEntrata: string;
  /** Reflected: __Dati_Numero010*/ 
  FlagAggiornaDaVoci: number;
  ...
  QuantitaItemEntrata: number;
  /** Reflected: __Dati_Numero014*/ 
  QuantitaItemUscita: number;
