...
import type { IDisattrezzaggiPrivate } from './Disattrezzaggi.Types.Private';


/* --------
* Schema Definition
* -------- */
const DisattrezzaggiSchema = new mongoose.Schema<IDisattrezzaggiPrivate>({
...
* Module Exports
* -------- */
export default DisattrezzaggiSchema;