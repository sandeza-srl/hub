export interface IInformazioniOfferteRevisioniPrivate {
_id: string;
/** Reflected: IdOfferta*/ 
__Dati_Testo001: string;
/** Reflected: Uno*/ 
__Dati_Numero001: number;
/** Reflected: IdInformazioneOfferte*/ 
...
/** Reflected: IdTipoInformazioneOfferta*/ 
...
/** Reflected: FlagAggiornaContenutiDaOfferte*/ 
...
/** Reflected: IdInformazioneOfferteRevisione*/ 
__Dati_Testo012: string;
/** Reflected: Integrazione_DatiVariAC*/ 
__Dati_Testo013: string;
/** Reflected: TxtValoreInformazioniOffertaRevisione_LinguaPredefinita*/ 
__Dati_Testo014: string;
/** Reflected: LinguaOfferta*/ 
__Dati_Testo015: string;
/** Reflected: TxtValoreInformazioniOffertaRevisione_InLinguaOfferta*/ 
