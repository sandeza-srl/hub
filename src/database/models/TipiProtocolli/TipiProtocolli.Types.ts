export interface ITipiProtocolli {
_id: string;
...
EtichettaJoinE: string;
/** Reflected: __Dati_Testo005*/ 
EtichettaJoinF: string;
/** Reflected: __Dati_Testo006*/ 
EtichettaJoinG: string;
...
EtichettaJoinH: string;
/** Reflected: __Dati_Testo013*/ 
EtichettaJoinI: string;
...
Stampa_NomeScriptImpostazioni: string;
/** Reflected: __Dati_Testo025*/ 
Stampa_NomeScriptStampaPdf: string;
