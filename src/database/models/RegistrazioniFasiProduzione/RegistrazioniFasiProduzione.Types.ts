...
CambioMacchina_FlagOpzioneProdDifferenteDaFase: number;
/** Reflected: __Dati_Testo070*/ 
CodiceRegistrazioneFaseProduzione: string;
/** Reflected: __Dati_Numero209*/ 
LavorazioneEsterna_FlagAperturaAutomatica: number;
/** Reflected: __Dati_Testo071*/ 
TracciabilitaRegistrazione_Origine_IdRegistrazioneFaseProduzione: string;
/** Reflected: __Dati_Testo072*/ 
TracciabilitaRegistrazione_Origine_CodiceRegistrazioneFaseProduzione: string;
/** Reflected: __Dati_Testo073*/ 
TracciabilitaRegistrazione_Origine_IdTipoContenitore: string;
/** Reflected: __Dati_Testo074*/ 
TracciabilitaRegistrazione_Origine_IdContenitore: string;
/** Reflected: __Dati_Testo075*/ 
TracciabilitaRegistrazione_Origine_IdNumeroDiSerie: string;
/** Reflected: __Dati_Testo076*/ 
Contenitori_IdTipoContenitore: string;
/** Reflected: __Dati_Numero210*/ 
QRimanenteDaProdurre_Tracciabilita_Opz: number;
/** Reflected: __Dati_Numero211*/ 
QRimanenteDaProdurre_Tracciabilita_Fin: number;
/** Reflected: __Dati_Testo077*/ 
TracciabilitaRegistrazione_Origine_IdRegistrazioneFaseProduzionePrecedente: string;
/** Reflected: __Dati_Testo078*/ 
Contenitori_CodiceTxtTipoContenitoreAutomatico: string
}