...
import type { IStoricoVariazioniListinoPrivate } from './StoricoVariazioniListino.Types.Private';


/* --------
* Schema Definition
* -------- */
const StoricoVariazioniListinoSchema = new mongoose.Schema<IStoricoVariazioniListinoPrivate>({
...
__Dati_Testo018: {
type: String,
alias: 'IdStoricoVariazioneListino',

},
__Dati_Numero017: {
type: Number,
alias: 'FlagRegolaFutura',
...
* Module Exports
* -------- */
export default StoricoVariazioniListinoSchema;