...
Entrata_IdRegistrazioneFaseProduzione: string;
/** Reflected: __Dati_Testo014*/ 
Entrata_IdFaseProduzione: string;
/** Reflected: __Dati_Testo015*/ 
Entrata_IdLottoProduzione: string;
...
Uscita_IdLottoProduzione: string;
/** Reflected: __Dati_Testo029*/ 
Uscita_IdFaseProduzione: string;
/** Reflected: __Dati_Testo030*/ 
Uscita_IdRigaOrdine: string;
/** Reflected: __Dati_Testo031*/ 
Entrata_IdRigaOrdine: string;
/** Reflected: __Dati_Testo032*/ 
Uscita_IdRegistrazioneFaseProduzione: string;
/** Reflected: __Dati_Testo033*/ 
IdRegistrazioneFaseProduzioneOrigine: string;
/** Reflected: __Dati_Testo034*/ 
Tracciabilita_CodiceRegistrazioneFaseProduzioneOrigine: string
}