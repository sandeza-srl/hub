export interface IDistintaImpianto {
  _id: string;
  ...
  TxtAttivitaEseguita: string;
  /** Reflected: __Dati_Testo034*/ 
  TxtAttivitaDaEseguire: string;
  /** Reflected: __Dati_Data003*/ 
  DataProssimaAttivita: Date;
  /** Reflected: __Dati_Data004*/ 
  DataEsecuzioneAttivita: Date;
  /** Reflected: __Dati_Numero009*/ 
  QuantitaAggiuntiva: number;
