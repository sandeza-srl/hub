...
/** Reflected: FlagArticoloDisponibileProduzione*/ 
__Dati_Numero011: number;
/** Reflected: IdDistintaLotto*/ 
__Dati_Testo008: string;
/** Reflected: Zero*/ 
__Dati_Numero012: number;
/** Reflected: Fornitura_IdFornituraItem*/ 
__Dati_Testo009: string;
/** Reflected: Fornitura_FlagAggiornaFornituraItem*/ 
__Dati_Numero013: number;
/** Reflected: Fornitura_GiorniApprovigionamento*/ 
__Dati_Numero014: number;
/** Reflected: Fornitura_DataConsegnaProposta*/ 
__Dati_Data002: Date;
/** Reflected: QtPerUmOpzione*/ 
