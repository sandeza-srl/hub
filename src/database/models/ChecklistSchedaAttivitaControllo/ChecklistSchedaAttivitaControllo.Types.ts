export interface IChecklistSchedaAttivitaControllo {
  _id: string;
  ...
  ValoreRilevatoTesto: string;
  /** Reflected: __Dati_Numero019*/ 
  ValoreRilevatoNumero: number;
  /** Reflected: __Dati_Data001*/ 
  ValoreRilevatoData: Date;
  /** Reflected: __Dati_DataOra003*/ 
  ValoreRilevatoDataOra: Date;
  /** Reflected: __Dati_Contenitore001*/ 
  ValoreRilevatoContenitore: string;
  /** Reflected: __Dati_Testo013*/ 
  IdCheckTipoAttivita: string;
  /** Reflected: __Dati_Testo014*/ 
  ValoreRilevatoAutomatico: string;
  /** Reflected: __Dati_Numero020*/ 
  FlagEseguito: number;
  /** Reflected: __Dati_Numero021*/ 
  FlagDaEseguire: number;
  ...
  IdDocumentoValore: string;
  /** Reflected: __Dati_Testo017*/ 
  TimeStampControllo: string;
  /** Reflected: __Dati_DataOra005*/ 
  DataOraRevisioneValore: Date;
  /** Reflected: __Dati_Testo018*/ 
  TxtUtenteRevisioneValore: string;
  ...
  CodiceTxtTipoControlloPosizioneAutomatico: string;
  ...
  CoordinateControlloQuotaX: number;
  /** Reflected: __Dati_Numero030*/ 
  CoordinateControlloQuotaY: number;
  /** Reflected: __Dati_Numero031*/ 
  CoordinateControlloQuotaZ: number;
  /** Reflected: __Dati_Testo041*/ 
  TxtFamigliaTipoControllo: string;
  ...
  ValoreRilevatoTestoRevisionato: string;
  /** Reflected: __Dati_Numero035*/ 
  FlagEsitoPositivoObbligatorio: number;
