export interface IElementiCostoRisorsa {
_id: string;
/** Reflected: __Dati_Testo001*/ 
CodiceVoceImpostazioneCosti: string;
/** Reflected: __Dati_Testo002*/ 
CodiceTxtVoceImpostazioneCosti: string;
