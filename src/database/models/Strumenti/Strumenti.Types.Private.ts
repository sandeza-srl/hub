export interface IStrumentiPrivate {
  _id: string;
  ...
  /** Reflected: TxtTipoStatoStrumento*/ 
  ...
  /** Reflected: IdTipoStatoStrumento*/ 
  ...
  /** Reflected: TxtTipoStatoStrumentoAutomatico*/ 
