...
FlagAggiornaContenutiDaTipiControlli: number;
/** Reflected: __Dati_Numero033*/ 
FlagAggiornaContenutiDaTipiPianoCampionamento: number;
/** Reflected: __Dati_Numero035*/ 
ValoreMinimoRegistrato: number;
/** Reflected: __Dati_Numero036*/ 
ValoreMassimoRegistrato: number;
/** Reflected: __Dati_Numero037*/ 
ValoreMedioRegistrato: number;
/** Reflected: __Dati_Numero038*/ 
DeviazioneStandardValoriRaccolti: number;
/** Reflected: __Dati_Numero039*/ 
DeviazioneStandardPercValoriRaccolti: number
}