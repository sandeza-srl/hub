export interface IAttivitaControllo {
  _id: string;
  ...
  DataUltimaAttivitaEseguita: Date;
  ...
  DataUltimaAttivitaPianificata: Date;
  ...
  OraInizioProgrammazione: string;
  ...
  FlagAutoAssociaAttivita: string;
  ...
  IdSottoTipoDocumentoStampa: string;
  /** Reflected: __Dati_Testo052*/ 
  IdTipoDocumentoStampa: string;
  ...
  CodiceTxtArticolo: string;
  /** Reflected: __Dati_Testo064*/ 
  CodiceTxtDocOperativo: string;
  /** Reflected: __Dati_Testo065*/ 
  CodiceTxtImpianto: string;
