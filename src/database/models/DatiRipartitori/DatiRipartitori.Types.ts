export interface IDatiRipartitori {
_id: string;
/** Reflected: __Dati_Numero001*/ 
Altezza: number;
/** Reflected: __Dati_Numero002*/ 
CoefficienteDispersioneVolumica: number;
...
IdRigaDistintaImpiantoCustom: string;
