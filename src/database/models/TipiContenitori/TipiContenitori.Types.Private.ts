export interface ITipiContenitoriPrivate {
_id: string;
/** Reflected: Uno*/ 
...
/** Reflected: NumeroContenitoriRottamati*/ 
__Dati_Numero007: number;
/** Reflected: NumeroContenitoriTotali*/ 
