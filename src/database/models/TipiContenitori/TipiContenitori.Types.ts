export interface ITipiContenitori {
  _id: string;
  ...
  NumeroContenitoriRottamati: number;
  /** Reflected: __Dati_Numero008*/ 
  NumeroContenitoriTotali: number;
