export interface IComunicazioniProduzione {
  ...
  IdAccountOperatoreCreazione: string;
  ...
  FlagNonConformita: number;
  /** Reflected: __Dati_Numero010*/ 
  FlagRichiestaManutenzione: number;
  /** Reflected: __Dati_Numero011*/ 
  FlagSuggerimento: number;
  /** Reflected: __Dati_Numero012*/ 
  FlagModificaProgramma: number;
  /** Reflected: __Dati_Testo047*/ 
  CodiceTipoComunicazioneProduzione: string;
  /** Reflected: __Dati_Testo048*/ 
  CodiceTxtTipoComunicazioneProduzione: string;
  /** Reflected: __Dati_Testo049*/ 
  FamigliaTipoComunicazioneProduzione: string;
  /** Reflected: __Dati_Testo050*/ 
  IdAccountOperatoriDestinatari: string;
  /** Reflected: __Dati_Testo051*/ 
  IdTipoAttivitaConseguenza: string;
  /** Reflected: __Dati_Testo052*/ 
  TxtTipoComunicazioneProduzione: string;
  /** Reflected: __Dati_Testo053*/ 
  IdDocumentoCollegato: string;
  /** Reflected: __Dati_Testo054*/ 
  IdTipoStatoComunicazione: string;
  /** Reflected: __Dati_Testo055*/ 
  OrdineTxtTipoStatoComunicazione: string;
  /** Reflected: __Dati_Testo056*/ 
  OrdineTipoStatoComunicazione: string;
  /** Reflected: __Dati_Numero013*/ 
  CollegamentoAllegati_Lotti_FlagDisattivato: number;
  /** Reflected: __Dati_Numero014*/ 
  CollegamentoAllegati_Articoli_FlagDisattivato: number;
