...
import type { IRigheOrdiniPrivate } from './RigheOrdini.Types.Private';


/* --------
* Schema Definition
* -------- */
const RigheOrdiniSchema = new mongoose.Schema<IRigheOrdiniPrivate>({
...
__Dati_Testo003: {
type: String,
alias: 'CodiceDocOperativoOrigine',
...
__Dati_Testo008: {
type: String,
alias: 'NomeSedeDestinazione',

},
__Dati_Data001: {
type: Date,
alias: 'DataDocOperativoOrigine',
set: (value: any) => {
...
__Dati_Data002: {
type: Date,
alias: 'DataRegistrazioneDocOperativoOrigine',
set: (value: any) => {
 return DateConverter.convertDate(value);
}
},
...
__Dati_Numero009: {
type: Number,
alias: 'FlagStato02InAttesa',

},
__Dati_Testo010: {
type: String,
alias: 'Avanzamento_TxtStatoRiga',
...
__Dati_Testo013: {
type: String,
alias: 'IdRubricaCliente',

},
__Dati_Testo014: {
type: String,
alias: 'NomeRubricaCliente',
...
__Dati_Numero031: {
type: Number,
alias: 'LTCreazioneInizioR',

},
__Dati_Numero032: {
type: Number,
alias: 'LTCreazioneInizioT',

},
__Dati_Numero033: {
type: Number,
alias: 'LT5InizioFineT',

},
__Dati_Numero034: {
type: Number,
alias: 'LT5InizioFineR',

},
__Dati_Numero035: {
type: Number,
alias: 'LTCreazioneLimite',

},
__Dati_Numero036: {
type: Number,
alias: 'LTConfermaFineR',
...
__Dati_Numero038: {
type: Number,
alias: 'LTConfermaLimite',

},
__Dati_Numero039: {
type: Number,
alias: 'LTConfermaSpedizione',

},
__Dati_Numero040: {
type: Number,
alias: 'LTCreazioneSpezione',

},
__Dati_Numero041: {
type: Number,
alias: 'LTConfermaInizioR',

},
__Dati_Numero042: {
type: Number,
alias: 'LTCreazioneFineT',

},
__Dati_Numero043: {
type: Number,
alias: 'LTCreazioneFineR',

},
__Dati_Numero044: {
type: Number,
alias: 'TempoLottiTeorico',
...
__Dati_Numero048: {
type: Number,
alias: 'MargineTotaleTeorico',

},
__Dati_Numero049: {
type: Number,
alias: 'MargineUnitarioTeorico',

},
__Dati_Numero050: {
type: Number,
alias: 'MarginePercentualeTeorico',

},
__Dati_Numero051: {
type: Number,
alias: 'MarginePercentualeReale',

},
__Dati_Numero052: {
type: Number,
alias: 'MargineTotaleReale',

},
__Dati_Numero053: {
type: Number,
alias: 'MargineUnitarioReale',

},
__Dati_Numero054: {
type: Number,
alias: 'DiffPercMargineTeoricoReale',

},
__Dati_Testo025: {
type: String,
alias: 'CodiceEsternoDocOperativoOrigine',
...
__Dati_Numero057: {
type: Number,
alias: 'LT4BenestareInizioT',

},
__Dati_Numero058: {
type: Number,
alias: 'BenestareProduzione_FlagBenestareDato',

},
__Dati_Numero059: {
type: Number,
alias: 'LT6FineRSpedizione',

},
__Dati_Numero060: {
type: Number,
alias: 'LT4BenestareInizioR',
...
__Dati_Numero065: {
type: Number,
alias: 'FlagAggiornaDaDocOperativoOrigine',

},
__Dati_Numero066: {
type: Number,
alias: 'FlagAggiorna01DaLotti',
...
__Dati_Numero127: {
type: Number,
alias: 'FlagCartellinoProduzioneStampato',
...
__Dati_Numero263: {
type: Number,
alias: 'Avanzamento_NumeroLottiTotale',

},
__Dati_Numero264: {
type: Number,
alias: 'Avanzamento_NumeroLottiSaldati',
...
* Module Exports
* -------- */
export default RigheOrdiniSchema;