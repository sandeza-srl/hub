export interface IFermiPrivate {
  _id: string;
  ...
  /** Reflected: FamigliaTipoFermo*/ 
  __Dati_Testo031: string;
  /** Reflected: FlagNotaPossibile*/ 
  ...
  /** Reflected: FlagCollegatoBenestare*/ 
