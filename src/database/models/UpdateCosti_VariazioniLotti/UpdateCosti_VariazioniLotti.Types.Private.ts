export interface IUpdateCosti_VariazioniLottiPrivate {
_id: string;
...
/** Reflected: CTAD_PostEsecuzione*/ 
__Dati_Numero001: number;
/** Reflected: CTB_PostEsecuzione*/ 
__Dati_Numero002: number;
/** Reflected: CTF_PostEsecuzione*/ 
__Dati_Numero003: number;
/** Reflected: CTL_PostEsecuzione*/ 
__Dati_Numero004: number;
/** Reflected: CTLE_PostEsecuzione*/ 
__Dati_Numero005: number;
/** Reflected: CTM_PostEsecuzione*/ 
__Dati_Numero006: number;
/** Reflected: CTP_PostEsecuzione*/ 
__Dati_Numero007: number;
/** Reflected: CTQ_PostEsecuzione*/ 
__Dati_Numero008: number;
/** Reflected: CTS_PostEsecuzione*/ 
__Dati_Numero009: number;
/** Reflected: CTT_PostEsecuzione*/ 
__Dati_Numero010: number;
/** Reflected: CTT_Ricarico_PostEsecuzione*/ 
__Dati_Numero011: number;
/** Reflected: CTTRA_PreEsecuzione*/ 
__Dati_Numero012: number;
/** Reflected: CTUt_PostEsecuzione*/ 
...
/** Reflected: IdSessioneUpdateCosti*/ 
__Dati_Testo011: string;
/** Reflected: IdVariazioneLottoUpdateCosti*/ 
...
/** Reflected: CTAD_PreEsecuzione*/ 
__Dati_Numero017: number;
/** Reflected: CTB_PreEsecuzione*/ 
__Dati_Numero018: number;
/** Reflected: CTF_PreEsecuzione*/ 
__Dati_Numero019: number;
/** Reflected: CTL_PreEsecuzione*/ 
__Dati_Numero020: number;
/** Reflected: CTLE_PreEsecuzione*/ 
__Dati_Numero021: number;
/** Reflected: CTM_PreEsecuzione*/ 
__Dati_Numero022: number;
/** Reflected: CTP_PreEsecuzione*/ 
__Dati_Numero023: number;
/** Reflected: CTQ_PreEsecuzione*/ 
__Dati_Numero024: number;
/** Reflected: CTS_PreEsecuzione*/ 
__Dati_Numero025: number;
/** Reflected: CTT_PreEsecuzione*/ 
__Dati_Numero026: number;
/** Reflected: CTT_Ricarico_PreEsecuzione*/ 
__Dati_Numero027: number;
/** Reflected: CTUt_PreEsecuzione*/ 
